			...
			<h3>States Of Object</h3>
			<pre class="">
 <strong>
Transient-> A simple java object is transient object

Persistent->Object after attached with hibernate, then it becomes the persistent state 

Detached->Object after removed from hibernate becomes detached object,detached object deleted by the garbage collector.
</strong>     
            </pre>
