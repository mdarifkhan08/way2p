...
if (isset ( $_POST ['create-account'] )) {
	...
	$post_data->createExpensesAccount($name);
    /*logActivity */
    $request_type_1='Post_user';
    $operation_table_1='expenses_account';
    $operation_page='expenses_account.php';
	...
	header('Location: expenses_account.php?result=success');
}
?>
<!DOCTYPE HTML>
<html ng-app="myApp">
...
<body >
	...
	<div class="container">
		...
		<div class="col-sm-7">
		<br/><br/>
		<h1>Create Expenses Account</h1><br/><br/>
				...
				<table class="table table-bordered" ng-controller="mainController">
					<tr>
						...
						<td><input type="text" name="txt_name" ng-model="onType" ng-keyup="onTypeWords()"class="form-control" required/>
                          <div ng-if="repeat.length>0" ng-cloak class="alert alert-danger">Account Name Already Exists</div>
...
if($location.host()=='localhost'){
   ...
   var mypath=$location.host();
}
$scope.onTypeWords=function(){
$http.get('/'+mypath+'/angularjs/interface/expenses/accounts/'+$scope.onType)
