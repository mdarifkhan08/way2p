...
if (isset ( $_POST ['create-account'] )) {
	...
	$post_data->createLiabilitiesAccount($name);
	header('Location: create_liabilities_account.php?result=success');
}
?>
<!DOCTYPE HTML>
<html ng-app="myApp">
...
<body >
	...
	<div class="container">
		...
		<div class="col-sm-7">
		<br/><br/>
		<h1>Create Liabilities Account</h1><br/><br/>
...
$http.get('/'+mypath+'/angularjs/interface/liabilities/accounts/'+$scope.onType)
