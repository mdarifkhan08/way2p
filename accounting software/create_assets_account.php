...
if (isset ( $_POST ['create-account'] )) {
	...
	$post_data->createAssetsAccount($name);
    /*logActivity */
	...
	header('Location: create_assets_account.php?result=success');
}
?>
<!DOCTYPE HTML>
<html ng-app="myApp">
...
<body >
	...
	<div class="container">
		...
		<div class="col-sm-7">
		<br/><br/>
		<h1>Create Assets Account</h1><br/><br/>
...
$http.get('/'+mypath+'/angularjs/interface/assets/accounts/'+$scope.onType)
