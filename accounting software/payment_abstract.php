...
$data=$get->getDataForPaymentAbstract();
$data1=$get->getDataForPayAndAbstractOrWhomSearch();


if(isset($_POST['submit'])){
	$whom=trim($_POST['whom']);
	$data=$get->getDataForPaymentWhomSearch($whom);
	$data1=$get->getSumDataForPaymentAbstractOrWhomSearch($whom);
}
?>
