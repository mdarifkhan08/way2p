...
$getDistinctYear=$get->getYearForPurchaseAbstract();
$getDistinctMonth=$get->getMonthForPurchaseAbstract();
  ...
  <div class="col-sm-3"></div>
	...
	<div class="container" style="width:800px;overflow-x:auto;" ng-controller="mainController">
		...
		<div align="center">
		  ...
		  <br/><br/>
		  <table border="0" ng-show="hidedata1" cellspacing="2" cellpadding="0" id="books" class="table table-bordered">
...
<script type="text/javascript" src="js/purchase_abstract.js"></script>
</body>
</html>