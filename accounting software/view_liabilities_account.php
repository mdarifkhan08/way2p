...
$data=$get->getLiabilitiesAccountRecords();
?>
<!DOCTYPE Html>
<html>
<head>
...
<div class="col-sm-3"></div>
	...
	<div class="container" style="width:800px;overflow-x:auto;" >
	  ...
	  <h1>View Liabilities Account</h1><br/><br/>
		<table border="0" cellspacing="0" cellpadding="0" id="books" class="table table-bordered">
            <tr><td>Account Name</td><td>Debit</td><td>Credit</td><td>Remaining</td></tr>
            <?php foreach($data as $d){ ?>
 <tr><td><?php echo $d['account_name'] ?></td><td><?php echo $d['d'] ?></td><td><?php echo $d['c'] ?></td><td><?php echo $d['d']-$d['c'] ?></td></tr>
            <?php } ?>
		</table>
	  </div>
	</div>
